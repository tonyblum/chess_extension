// I know pasting the jquery code below is bad style, but Rob said its cool, so whatever
...
// code to make divs at http://stackoverflow.com/questions/17979903/chrome-extension-insert-fixed-div-as-ui
...
div2.style.top = '2%';
div2.style.left = '52.4%';
div2.style.width = '142px';
...
// add div 3 with players name and location next to picture
...
div4.style.left = '2%';
div4.style.width = '7%';
div4.style.height = '15%';
div4.style.backgroundColor = 'tan';
div4.style.zIndex = "2";
...
div6.style.left = '.8%';
div6.style.width = '10%';
div6.style.height = '30%';
div6.style.backgroundColor = 'white';
div6.style.zIndex = "9999";
$('<p>Loading ...</p>')
    .appendTo('#myDivId5');
 
var opponent = 'Extra stuff';
var player = $('#playername2.playername')
    .text();
var playercleaned = player.replace("WhiteWhite", "");
 
$.ajax({
    url: "http://www.chess.com/members/view/" + playercleaned,
    cache: false,
    success: function(response) {
 
        opponent = $(response)
            .find(".section-content-2")
            .html();
        console.log("http://www.chess.com/members/view/" + playercleaned);
        div.innerHTML = "";
        div.innerHTML = playercleaned;
        div.innerHTML = div.innerHTML + opponent;
        ...
        img1 = $(response)
            .find(".avatar-container.bottom-8")
            .html();
        img1.id = 'myImg1';
        div5.innerHTML = img1;
        $("#myDivId5")
...
var opponent2 = 'Extra stuff';
var player2 = $('#playername1.playername')
    .text();
var playercleaned2 = player2.replace("BlackBlack", "");
 
$.ajax({
    url: "http://www.chess.com/members/view/" + playercleaned2,
    cache: false,
    success: function(response) {
        ...
        opponent2 = $(response)
            .find(".section-content-2")
            .html();
        console.log("http://www.chess.com/members/view/" + playercleaned2);
        div2.innerHTML = "";
        div2.innerHTML = playercleaned2;
        div2.innerHTML = div2.innerHTML + opponent2;
...
if (!(window.location.href.indexOf("live.chess.com") > -1)) {
